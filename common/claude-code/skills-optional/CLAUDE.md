...
vault goes under `../workshop/<language>/packages/<section>/<name>/skills/`
(or `../workshop/general/packages/<name>/skills/`) instead, and reaches
a project as a committed copy with `stack add <name>` — see
`../workshop/stack/CLAUDE.md`. The trees here are the candidates to move there.
...
other clones carry them. See `../workshop/workbench/CLAUDE.md`.
