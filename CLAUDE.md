...
| ------------------ | ----------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `skills/`          | symlinked to `~/.claude/skills/` (global) | `bugfix`, `codebase-design`, `deepen`, `densify`, `docx`, `frontend-design`, `grilling`, `human-like-text`, `pdf`, `private-remote`, `prototype`, `resolving-merge-conflicts`, `show-me`, `wat` |
