...
| ------------------ | ----------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `skills/`          | symlinked to `~/.claude/skills/` (global) | `caveman`, `codebase-design`, `debloat`, `deepen`, `densify`, `docx`, `frontend-design`, `grilling`, `human-like-text`, `indexer`, `pdf`, `prototype`, `resolving-merge-conflicts`, `show-me`, `simple-english`, `skill-creator`, `wat`, `write-a-skill`, `writing-for-agents` |
