...
| **tmux**             | `common/tmux/tmux.conf.tpl`         | Terminal multiplexer: prefix key, panes, status bar (themed), attention glyphs and counts, popups (`prefix g` lazygit, `prefix t` scratch shell, `prefix e` scrollback in nvim with `]]`/`[[` between prompts — `common/nvim/lua/scrollback.lua`)                                                                                                                                                                                                                                             |
